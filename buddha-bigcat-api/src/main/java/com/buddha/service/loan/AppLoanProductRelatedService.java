...
import com.buddha.mapper.loan.AppLoanProductRelatedMapper;
...
@Service
@DS("bigcat_loan")
public class AppLoanProductRelatedService extends ServiceImpl<AppLoanProductRelatedMapper, AppLoanProductRelated> {
